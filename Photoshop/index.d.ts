...
declare class global {
	 ...
	 */
	static readonly app: Application;
	 ...
	 */
	static encodeURI(text: string): string;
	 ...
	 * @param text The text to encode.
	 */
	static encodeURIComponent(text: string): string;
	 ...
	 */
	static escape(aString: string): string;
	 ...
	 */
	static eval(stringExpression: string): any;
	 ...
	 */
	static isFinite(expression: number): boolean;
	 ...
	 * @param expression Any valid JavaScript expression.
	 */
	static isNaN(expression: number): boolean;
	 ...
	 */
	static localize(what: string, argument?: any): string;
	 ...
	 */
	static parseInt(text: string, base?: number): number;
	 ...
	 */
	static setDefaultXMLNamespace(namespace: Namespace): void;
