...
declare interface _BrushOrPenType {
    SOLID_COLOR;
    THEME_COLOR;
}
...
declare class ScriptUIGraphics {
     ...
     */
    readonly BrushType: _BrushOrPenType;

    /**
     * Contains the enumerated constants for the type argument of newPen().
     * Type constants are: SOLID_COLOR, THEME_COLOR.
     */
    readonly PenType: _BrushOrPenType;
     ...
     */
    newBrush(
        type: typeof ScriptUIGraphics.BrushType,
        color: number[]
    ): ScriptUIBrush;
     ...
     */
    newPen(
        type: typeof ScriptUIGraphics.PenType,
        color: number[],
        width: number
    ): ScriptUIPen;
