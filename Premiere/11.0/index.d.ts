...
declare class Project extends PremiereObject {
  ...
  exportAAF(
    sequence: Sequence,
    filePath: string,
    mixDownVideo: NumericalBool,
    explodeToMono: NumericalBool,
    sampleRate: SampleRateOption,
    bitsPerSample: BitsPerSampleOption,
  ...
  exportOMF(
    ...
    sampleRate: SampleRateOption,
    bitsPerSample: BitsPerSampleOption,
    audioEncapsulated: NumericalBool,
    audioFileFormat: AudioFileFormat,
...
declare class Application extends PremiereObject {
  /**
