...
/***** Taken from JavaScript.d.ts *****/
// There are too many conflicts with simply including JavaScript.d.ts in here.
// So here are a few interfaces and classes that have been copied here.
...
/**
 * Represents an ImageFromat that may be sent in to SpriteSheetExporter.exportSpriteSheet();
 */
...
declare class FLfile {
   ...
   * @returns A Boolean value of true if successful; false otherwise.
   * @param foleOrFolderURI A string, expressed as a file:/// URI, specifying the file or folder you want to remove (delete).
   */
  remove(foleOrFolderURI: string): boolean;
  /**
...
interface flash {
   ...
   * "jsfl;fla;as"
   */
  browseForFileURL(browseType: string, title?: string, fileDescription?: string, fileFilter?: string): string | null;
  /**
...
declare class SpriteSheetExporter extends Item {
   ...
   */
  addSymbol(symbol: SymbolItem | SymbolInstance, name?: string, beginFrame?: number, endFrame?: number): boolean;
  /**
   ...
   */
  exportSpriteSheet(path: string, imageFormat?: string | ImageFormat, writeMetaData?: boolean): string;;
  /**
...
declare class Document {
   ...
   */
  addNewOval(boundingRectangle: SimpleShape, bSuppressFill?: boolean, bSuppressStroke?: boolean): void;
  /**
   ...
   */
  addNewPrimitiveOval(boundingRectangle: SimpleShape, bSuppressFill?: boolean, bSuppressStroke?: boolean): void;
  /**
   ...
   */
  addNewPrimitiveRectangle(boundingRectangle: SimpleShape, roundness: number, bSuppressFill?: boolean, bSuppressStroke?: boolean): void;
  /**
   ...
   * @param bSuppressStroke A Boolean value that, if set to true, causes the method to create the rectangle without a stroke. The default value is false. This parameter is optional.
   */
  addNewRectangle(boundingRectangle: SimpleShape, roundness: number, bSuppressFill?: boolean, bSuppressStroke?: boolean): void;
  /**
  ...
  /**
   * Mmoves selected objects by a specified distance.
   ...
   * @param bContactSensitiveSelection A Boolean value that specifies whether the Contact Sensitive selection mode is enabled (true) or disabled (false) during object selection. The default value is false.
   */
  setSelectionRect(rect: SimpleShape, bReplaceCurrentSelection?: boolean, bContactSensitiveSelection?: boolean): void;
  /**
...
declare class VideoItem extends Item {
  ...
  readonly sourceFilePath: string;
  /**
   * A tring that specifies the type of video the item represents. Possible values are "embedded video" and "video".
   */
...
declare class Timeline {
   ...
   */
  getFrameProperty(property: string, startframeIndex?: number, endFrameIndex?: number): string | undefined;
  /**
